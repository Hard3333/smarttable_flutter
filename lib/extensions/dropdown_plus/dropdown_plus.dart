...
class DropdownFormFieldState<T> extends State<DropdownFormField>
  ...
  @override
  void didUpdateWidget(covariant DropdownFormField oldWidget) {
    super.didUpdateWidget(oldWidget);
    if(_effectiveController!.value != _selectedItem){
      setState(() => _selectedItem = _effectiveController!.value);
    }
  }
